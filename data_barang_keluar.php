                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($data_barang_keluar as $row) {
                            $harga_diskon = $row['harga'] * $row['diskon'] / 100;
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span>Diskon : <?php echo $row['diskon'] ?>%</li></span><br>
                                    <span>Total : Rp<?php echo number_format($row['total']) ?></span>
                                </td>
                                <td align="center" width="150px">
                                    <a class="btn btn-sm btn-warning" href="data_barang_keluar.php?edit=update&&id=<?= $row['no_ref'] ?>">Edit</a>
                                    <a class="btn btn-sm btn-danger" href="proses_barang_keluar.php?aksi=delete&&id=<?= $row['no_ref'] ?>" onclick="return confirm('Apakah yakin data dihapus')">Delete</a>
                                </td>
                            </tr>
                        <?php
                        }
